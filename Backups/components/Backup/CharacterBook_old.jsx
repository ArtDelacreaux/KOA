...
const relTempTrack = (v) => {
  ...
  const tabButtonStyle = (active) => ({
    ...
    background: active ? 'rgba(176,101,0,0.18)' : 'rgba(255,255,255,0.38)',
    cursor: 'pointer',
    fontWeight: 950,
    fontSize: 12,
    letterSpacing: 0.25,
  ...
  const cardShell = (bg = 'rgba(255,245,220,0.94)', fg = '#222') => ({
  ...
  /* ---------- Data: party feelings + characters ---------- */
  const partyFeelings = {
    William: {
      Cerci: 'Quiet trust. Protective and tethered to hope.',
      Fen: 'Respects her strength; relies on her when things turn ugly.',
      Arlis: 'Old feelings resurfacing. Wary of what she knows.',
      Castor: 'A living reminder. Complicated, but not hatred.',
      "Von'Ghul": 'Grateful for his steadiness; cautious of his secrets.',
      Thryvaris: 'Uncertain. Useful knowledge… and unknown motives.',
    },
    Cerci: {
      William: 'Deep bond. A rare anchor that feels real.',
      Fen: 'Likes her straightforwardness. Feels safer around her.',
      Arlis: 'Suspicious at first—then curious. Watches her closely.',
      Castor: 'Sees him as separate, not a mistake. Protective instinct.',
      "Von'Ghul": 'Trusts him more than she admits.',
      Thryvaris: 'Avoids him. Old magic smells like trouble.',
    },
    Fen: {
      William: 'Calls him soft—would still die for him.',
      Cerci: 'Respects her grit. Stops short of “friend”… barely.',
      Arlis: 'Doesn’t trust the fancy smile. Keeps one eye on her.',
      Castor: 'Recognizes the survivor in him. Begrudging respect.',
      "Von'Ghul": 'Old-head approval. Listens when he speaks.',
      Thryvaris: 'Magic gives Fen a headache. Not a fan.',
    },
    Arlis: {
      William: 'Protective affection. Guilt about lost time.',
      Cerci: 'Wants her approval. Tries too hard sometimes.',
      Fen: 'Terrified of her honesty. Respects it anyway.',
      Castor: 'Fascinated. Unsure if she should feel sympathy or fear.',
      "Von'Ghul": 'Treats him politely. Doesn’t pry (much).',
      Thryvaris: 'Wants answers. Gets stonewalled.',
    },
    Castor: {
      William: 'A shadow he refuses to live under. Still… connected.',
      Cerci: 'Respect. She looks at him like he’s real.',
      Fen: 'Constant friction. But he trusts her in a fight.',
      Arlis: 'Doesn’t buy her act. Keeps her at arm’s length.',
      "Von'Ghul": 'Brother-in-arms. The closest thing to family.',
      Thryvaris: 'Doesn’t trust him. “Wizard vibes are wrong.”',
    },
    "Von'Ghul": {
      William: 'Wants the kid to survive. Doesn’t like the pact.',
      Cerci: 'Respects her restraint. Watches her hunger though.',
      Fen: 'Good fighter. Simple. Reliable.',
      Arlis: 'Too many secrets. Keeps her on a short leash.',
      Castor: 'Protective. Worried he’ll get used as a tool.',
      Thryvaris: 'Old magic is old danger. Keeps distance.',
    },
    Thryvaris: {
      William: 'Interesting. Potentially valuable. Potentially doomed.',
      Cerci: 'A rare case. Observes more than he speaks.',
      Fen: 'Predictable. Easy to steer if needed.',
      Arlis: 'Clever. Could be annoying.',
      Castor: 'A fractured soul is a research question with teeth.',
      "Von'Ghul": 'A hunter. Hunters ask inconvenient questions.',
    },
  };
  const characters = [
    {
  ...
  const selectedPartyFeelings = useMemo(() => {
    if (!selectedChar) return null;
    return partyFeelings[selectedChar.name] || null;
  }, [selectedChar]);
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 14, justifyContent: 'center' }}>
              {characters.map((char) => (
                <div
                  key={char.name}
                  style={charGridCard}
                  onMouseDown={playClick} // NAV: grid -> detail
                  onClick={() => {
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: 16, alignItems: 'start' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <div style={softCard}>
                  ...
                  {!selectedPartyFeelings ? (
                    <div style={{ opacity: 0.85 }}>No party relationship notes yet for this character.</div>
                  ) : (
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                      {Object.entries(selectedPartyFeelings).map(([otherName, feeling]) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div style={{ marginTop: 8, fontSize: 12, opacity: 0.88, lineHeight: 1.45 }}>{feeling}</div>
                            ...
                            {isEditing ? (
                              ...
                              <div style={{ marginTop: 8, fontSize: 12, opacity: 0.9, fontStyle: 'italic' }}>{note}</div>
                            ) : null}
                          </div>
                        );
                      })}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: 12 }}>
                {(selectedChar.npcs || []).map((npc) => (
                  <div
                    key={npc.name}
                    style={softCard}
                    onMouseDown={playClick} // NAV: relations -> npc
                    onClick={() => {
                      setSelectedNpc(npc);
                      setCharView('npc');
                    }}
